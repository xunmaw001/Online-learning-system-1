...
public class DiscussjifenshangpinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussjifenshangpinEntity discussjifenshangpin, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussjifenshangpinEntity discussjifenshangpin, HttpServletRequest request){
        EntityWrapper<DiscussjifenshangpinEntity> ew = new EntityWrapper<DiscussjifenshangpinEntity>();
		PageUtils page = discussjifenshangpinService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussjifenshangpin), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussjifenshangpinEntity> wrapper = new EntityWrapper<DiscussjifenshangpinEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussjifenshangpinService.selectCount(wrapper);
