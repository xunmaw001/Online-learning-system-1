...
public class JifenduihuanController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JifenduihuanEntity jifenduihuan, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xuesheng")) {
			jifenduihuan.setXuehao((String)request.getSession().getAttribute("username"));
		}
