...
public class JifenduihuanVO  implements Serializable {
	...
	private String duihuanshenqing;
	...
	public void setDuihuanshenqing(String duihuanshenqing) {
		this.duihuanshenqing = duihuanshenqing;
	}
	
	/**
	 * 获取：兑换申请
	 */
	public String getDuihuanshenqing() {
		return duihuanshenqing;
	}
