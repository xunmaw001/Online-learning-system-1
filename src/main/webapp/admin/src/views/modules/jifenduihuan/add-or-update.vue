    ...
    >
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="所需积分" prop="suoxujifen">
          <el-input v-model="ruleForm.suoxujifen" 
              placeholder="所需积分" clearable  :readonly="ro.suoxujifen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所需积分" prop="suoxujifen">
              <el-input v-model="ruleForm.suoxujifen" 
          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="兑换申请" prop="duihuanshenqing">
          <el-input v-model="ruleForm.duihuanshenqing" 
              placeholder="兑换申请" clearable  :readonly="ro.duihuanshenqing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="兑换申请" prop="duihuanshenqing">
              <el-input v-model="ruleForm.duihuanshenqing" 
                placeholder="兑换申请" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
            continue;
	            	            ...
	            	            if(o=='duihuanshenqing'){
            this.ruleForm.duihuanshenqing = obj[o];
	    this.ro.duihuanshenqing = true;
            continue;
          }
	            	            if(o=='shouhuodizhi'){
