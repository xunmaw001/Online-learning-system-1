  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="资料名称" prop="ziliaomingcheng">
              <el-input v-model="ruleForm.ziliaomingcheng" 
                placeholder="资料名称" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.ziliaotupian" label="资料图片" prop="ziliaotupian">
          <file-upload
          tip="点击上传资料图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaotupian" label="资料图片" prop="ziliaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.ziliaotupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="价格" prop="jiage">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.ziliaoxiangqing" label="资料详情" prop="ziliaoxiangqing">
                    <span v-html="ruleForm.ziliaoxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fufeiziliao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fufeiziliaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
