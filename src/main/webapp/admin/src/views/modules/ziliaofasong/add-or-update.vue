          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="资料文档" prop="ziliaowendang">
          <file-upload
          tip="点击上传资料文档"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.ziliaowendang?ruleForm.ziliaowendang:''"
          @change="ziliaowendangUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.ziliaowendang" label="资料文档" prop="ziliaowendang">
            <el-button type="text" size="small" @click="download(ruleForm.ziliaowendang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
            continue;
	            	            ...
	            	            if(o=='ziliaowendang'){
            this.ruleForm.ziliaowendang = obj[o];
	    this.ro.ziliaowendang = true;
            continue;
          }
	                    }
                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `ziliaofasong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.ziliaofasongCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                    ...
                                                                                    ziliaowendangUploadChange(fileUrls) {
                this.ruleForm.ziliaowendang = fileUrls;
				this.addEditUploadStyleChange()
            },
            	addEditStyleChange() {
	  this.$nextTick(()=>{
